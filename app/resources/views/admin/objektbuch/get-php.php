...
<div id="quicklinksBox" class="ui black xbig right attached sticky fixed button transition hidden quicklinks not-printable" data-context="body">
    <i class="content icon"></i>
    <span class="text">Tabellen</span>
    <div class="quicklinks-nav">
        <a href="#top10Artikel">Top-Artikel</a>
        <a href="#top10Raeume">Top1-Räume</a>
        <a href="#Raeume">Räume</a>
        <a href="#Artikel">Artikel</a>

        <a href="#Inventar" style="display:none;">Inventar</a>
        <a href="#BCGenerator" style="display:none;">Neue Barcodes</a>
    </div>
</div>

<a name="top10Artikel" class="not-printable"></a>
<table id="topTenArtikel" class="objectbook-table ui red celled unstackable padded table">
</table>

<a name="top10Raeume" class="not-printable"></a>
<table id="topTenRaeume" class="objectbook-table ui blue celled padded table">
</table>

<a name="Raeume" class="not-printable"></a>
<table id="Raeume" class="objectbook-table ui blue celled padded table">
</table>

<a name="Artikel" class="not-printable"></a>
<table id="Artikel" class="objectbook-table ui red celled padded table">
</table>
...
<div class="not-printable" style="display:none;">
                ...
                if (rowData.Etage) {
                    ...
                    switch(barcodeRenderer) {
                        case 'lindell':
                            ...
                            $( this )
                                .append( $("<div/>").attr('id', LBCIdBox).append( $('<svg id="' + LBCId + '"></svg>') ) );
                    ...
                    $(this).append( $("<div/>").text( text ).css({float: 'right'}) );
            }},
        ...
        fields: {
            Barcode: {
                ...
                formatter: function(val, colname, rowElm, rowData) {
                    ...
                    $(this).append( $("<div/>").text( text ).css({ marginTop: '1rem'} ));
                }},
...
<script>
    ...
    topArtikelConf.title = 'Top-Ten Artikel / ' + mandant.Mandant + ' / ' + inventur.Titel;
    ...
    topRaeumeConf.title = 'Top-Ten Räume' + ' / ' + mandant.Mandant + ' / ' + inventur.Titel;
    ...
    if (1) {
        ...
        /*
        dataTable( '#topTenRaeume', aTopTenRaeume, raeumeConf).orderby('numInventar').render();
        dataTable( '#topTenArtikel', aTopTenArtikel, artikelConf );

        dataTable( '#Raeume', aRaeume,
            $.extend({}, raeumeConf, { title: 'Liste alle Räume mit Anzahl zugewiesener Objekte'}));

        dataTable( '#Artikel', aArtikel, artikelConf,
            $.extend({}, artikelConf, { title: 'Liste aller Artikel mit Anzahl inventarisierter Objekte'}));
        */

        if (0) $.get('/api/admin/objektbuch/<?= $jobid ?>/listInventarBarcodes', function(data) {
    ...
    $(function() {
        $("#quicklinksBox").removeClass('transition hidden').appendTo("body");
    });
</script>
