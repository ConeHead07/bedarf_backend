...
<div id="formBoxCreateUser" class="ui small modal scrolling">
    ...
    <div class="actions">
        ...
        <div id="btnCancel" class="ui negative right labeled icon button">
            Abbrechen
                        ...
                        function (data) {
                            ...
                            if ('success' in data && data.success === true) {
                                ...
                                $('#basicDialog')
                                    ...
                                    .find('.dialog-text').text('Benutzer wurde angelegt und Ansicht wird neu geladen!').end()
                                    .modal({
                                        onApprove: function() {
            ...
            footer: [
                {
                    ...
                    formatter: function(fields) {
                        var btnAdd = $('<div/>').addClass('ui button primary').text('+ add').css('float', 'left')
                            .click( function(e) {
                                $("#formBoxCreateUser").modal('show');
                            });
                        $(this).append( btnAdd );
